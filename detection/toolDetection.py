...
def check_opened_drawers():
    with open('cekmeceListesi.txt', 'r') as drawerTxt:
        opened_drawers = drawerTxt.readlines()
        opened_drawers = [int(x) for x in opened_drawers]
...
def detect_pre(source, save_img=False):
...
def detect_post(dataset, device, half, model, classify, webcam,
                save_dir, names, save_txt, save_img, view_img, colors, imgsz, modelc=None):
    # Run inference
    if device.type != 'cpu':
...
def detect_drawer_1():
    ...
    if not drawer_1_executed_first_one:
        ...
        ) = detect_pre(source='sonuclar/cekmece1/camera1/1')
        ...
        ) = detect_pre(source='sonuclar/cekmece1/camera2/1')
        threadLock.acquire()
...
def detect_drawer_2():
    ...
    if not drawer_2_executed_first_one:
        ...
        ) = detect_pre(source='sonuclar/cekmece2/camera1/1')
        ...
        ) = detect_pre(source='sonuclar/cekmece2/camera2/1')
        threadLock.acquire()
...
def detect_drawer_3():
    ...
    if not drawer_3_executed_first_one:
        ...
        ) = detect_pre(source='sonuclar/cekmece3/camera1/1')
        ...
        ) = detect_pre(source='sonuclar/cekmece3/camera2/1')
        threadLock.acquire()
...
def detect_drawer_4():
    ...
    if not drawer_4_executed_first_one:
        ...
        ) = detect_pre(source='sonuclar/cekmece4/camera1/1')
        ...
        ) = detect_pre(source='sonuclar/cekmece4/camera2/1')
        threadLock.acquire()
...
def detect_drawer_5():
    ...
    if not drawer_5_executed_first_one:
        ...
        ) = detect_pre(source='sonuclar/cekmece5/camera1/1')
        ...
        ) = detect_pre(source='sonuclar/cekmece5/camera2/1')
        threadLock.acquire()
...
def detect_drawer_6():
    ...
    if not drawer_6_executed_first_one:
        ...
        ) = detect_pre(source='sonuclar/cekmece6/camera1/1')
        ...
        ) = detect_pre(source='sonuclar/cekmece6/camera2/1')
        threadLock.acquire()
...
if __name__ == '__main__':
    ...
    opt.source = "sonuclar/cekmece1/camera1/1"
    opt.weights = "best.pt"
    # opt.img_size = 640
    # opt.conf_thres = 0.25
    # opt.iou_thres = 0.45
    ...
    input("Model yüklendi lütfen bir tuşa basınız:")
    print("waking up")

    openedDrawersList = check_opened_drawers()
