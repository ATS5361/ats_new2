...
class CameraThread:
    ...
    def __init__(self, aruco_dict, parameters):
    ...
    def __new__(cls, *args, **kwargs):
        if cls._instance is None:
            cls._instance = super(VL53, cls).__new__(cls, *args, **kwargs)
            print("SensorManager instance created.")
            cls._instance.startSerial(baudrate=115200, port="/dev/ttyUSB0")
    ...
    def run(self):
        while True:
            ...
            self.new_frame.emit(frame, ids, corners)
